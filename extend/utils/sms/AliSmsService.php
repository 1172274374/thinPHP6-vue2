...
class AliSmsService
{
	...
	public static function sendSms($data){
		...
		$params["SignName"] = config('rds.ali_sms_signname');
		$params["TemplateCode"] = config('rds.ali_sms_tempCode');
		...
		$content = self::request(config('rds.ali_sms_accessKeyId'),config('rds.ali_sms_accessKeySecret'),"dysmsapi.aliyuncs.com",
