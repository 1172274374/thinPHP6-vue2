<template>
	<div>
		<vxe-modal
			...
			<!--标题-->
			<template #title>
				<span style="font-weight: bold;">统计设置</span>
			</template>
			<!--主体-->
			<template #default>
...
export default {
	...
	methods: {
		open(){
			...
			this.jump = url + '/#/admin/admin.statisic/index.html?' + this.$MyUtils.obj2Param(query)
			}
			if(process.env.NODE_ENV == 'production'){
			this.jump = url + '/dist/#/admin/admin.statisic/index.html?' + this.$MyUtils.obj2Param(query)
			}
