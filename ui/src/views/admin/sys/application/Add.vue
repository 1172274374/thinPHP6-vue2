<template>
  <div>
    <vxe-modal
      ...
      <!--标题-->
      <template #title>
        <span style="font-weight: bold;">添加应用</span>
      </template>
      <!--主体-->
      <template #default>
      ...
      <!--底部-->
      <template #footer>
        <el-button :size="size" :loading="loading" type="primary" @click="submit" :disabled="form.app_type == '1'">
...
<script>
import {createApplication, getTableList} from '../sys'
